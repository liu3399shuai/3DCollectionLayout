...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    long int numberOfVisibleItems = [self.collectionView numberOfItemsInSection:0 ];
    ...
    NSLog(@"Offset %@ %ld %f %f",NSStringFromCGPoint(collection.contentOffset),indexPath.item,radius,angle);
